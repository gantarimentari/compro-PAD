...
import NotificationHistoryPageClient from './_components/NotificationHistoryPageClient';
import NotificationFilterButtons from './_components/NotificationFilterButtons';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-accent-yellow-350" style={backgroundStyle}>
      ...
      <main className="flex-grow relative">
        ...
        <NotificationHistoryPageClient activeFilter={activeFilter} />
      </main>
